# Generated by Django 5.2.4 on 2025-12-17 00:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "coordenadas",
                    models.JSONField(
                        default=apps.sales.models._load_default_gondola,
                        help_text="Coordenadas do objeto no mapa (polígono)",
                        validators=[
                            apps.sales.validators.CoordinateListValidator(
                                required_length=4
                            )
                        ],
                    ),
                ...
                (
                    ...
                    models.FloatField(
                        ...
                        validators=[apps.sales.validators.PositiveNumberValidator()],
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.UUIDField(
                        default=apps.core.models.UniqueUUIDGenerator(
                            "sales", "GondolaProduct", "id"
                        ),
                        editable=False,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(max_length=16, verbose_name="chave de acesso"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "map",
                    apps.sales.models.CustomMapField(
                        default=apps.sales.models._load_default_map, verbose_name="Mapa"
                    ),
                ),
                (
                    "establishment",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("establishment", "name"), name="unique_establishment_gondola"
            ),
        ),
        migrations.AddConstraint(
